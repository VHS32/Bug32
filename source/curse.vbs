' Decompiled version of executable file, maybe creator has embed some more files into this executable which is mixed with real one.
' But pretty sure you can just do a recreate it.
